...
# Flags
# COMMON_GLOBAL_CFLAGS += -DmotorolaLOG
...
BOARD_EGL_CFG := device/motorola/falcon/configs/egl.cfg
...
MR_DPI := hdpi
MR_DPI_FONT := 160
MR_INFOS := device/motorola/falcon/multirom/mrom_infos
MR_FSTAB := device/motorola/falcon/multirom/mrom_falcon.fstab
...
###MR_ENCRYPTION := true
###MR_ENCRYPTION_SETUP_SCRIPT := device/motorola/m7univ/multirom/mr_cp_crypto.sh
